...
> CodeZero extends RL Swarm beyond reasoning and math into **coding tasks**, where models take on distinct roles, _Solvers_, _Proposers_, and _Evaluators_, to enable **collaborative learning** across a decentralized network.
...
CodeZero replaces the previous _reasoning-gym_ environment, introducing a new task domain focused on programming challenges and model-based evaluation.
